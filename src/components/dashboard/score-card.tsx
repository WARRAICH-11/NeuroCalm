      ...
      <CardContent className="space-y-6">
        <div className="grid grid-cols-2 gap-6 text-center">
          <div>
            ...
            <p className="text-sm text-muted-foreground">Calm Index</p>
          </div>
          <div>
            ...
            <ChartContainer config={chartConfig} className="h-full w-full">
              <ResponsiveContainer width="100%" height="100%">
                  <LineChart data={chartData} margin={{ top: 5, right: 20, left: -10, bottom: 5 }}>
                    ...
                    <Line dataKey="calmIndex" name="Calm" type="monotone" stroke="var(--color-calm)" strokeWidth={2} dot={true} />
                    <Line dataKey="productivityIndex" name="Productivity" type="monotone" stroke="var(--color-productivity)" strokeWidth={2} dot={true} />
                  </LineChart>
              </ResponsiveContainer>
            </ChartContainer>
        </div>
